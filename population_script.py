...
def populate():
    ...
    add_story('1', '4', 'As player I want to defend a base\nPoint : 4\nPriority : Low', 'Defend Base', '60px',
              '320px', '200px', '100px', 'sticky-note-pink-theme', '2', 'high')
